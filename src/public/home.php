                ...
                <div class="col-md-6">
                    <div class="card mb-4 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <a href="/Zoo-Arcadia-New/habitat/<?php echo $habitat['id']; ?>" class="btn btn-success btn-block">Voir les habitants</a>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
            ...
            <div class="col-md-4">
                <div class="card-rounded mb-4 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <a href="/Zoo-Arcadia-New/animal/<?php echo $animal['id']; ?>" class="btn btn-success btn-block" onclick="registerClick(<?php echo $animal['id']; ?>)">En savoir plus</a>
                        </div>
                </div>
            </div>
        <?php endforeach; ?>
