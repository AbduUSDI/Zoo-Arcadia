...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Etablissement du dossier cible pour importer le fichier image, sur ce projet c'est dans "uploads"
    ...
    if ($image['size'] > 0) {
        ...
        // Utilisation de la méthode "updateServiceAvecImage" pour une modification avec une nouvelle image
